...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    List allSeries = context.watch<MoviesProvider>().series;
    List allCartoons = context.watch<MoviesProvider>().cartoons;
    List allMovies = context.watch<MoviesProvider>().movies;
